...
rm -rf $product/app/AdaptiveVPNPrebuilt*
rm -rf $product/app/AndroidAutoStubPrebuilt
...
rm -rf $product/app/VoiceAccessPrebuilt
...
rm -rf $product/priv-app/NgaResources
